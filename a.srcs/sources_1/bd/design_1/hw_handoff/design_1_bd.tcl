...
proc create_root_design { parentCell } {
  ...
  # Create instance: BLANKING_HEIGHT, and set properties
  set BLANKING_HEIGHT [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 BLANKING_HEIGHT ]
  set_property -dict [ list CONFIG.C_ALL_OUTPUTS {1} CONFIG.C_DOUT_DEFAULT {0x00000154} CONFIG.C_GPIO_WIDTH {10}  ] $BLANKING_HEIGHT
  ...
  set_property -dict [ list CONFIG.NUM_MI {6}  ] $axi_mem_intercon
...
CONFIG.PCW_WDT_PERIPHERAL_ENABLE {1}  ] $processing_system7_0
  ...
  connect_bd_intf_net -intf_net axi_mem_intercon_M05_AXI [get_bd_intf_pins BLANKING_HEIGHT/S_AXI] [get_bd_intf_pins axi_mem_intercon/M05_AXI]
  ...
  connect_bd_net -net BLANKING_HEIGHT_gpio_io_o [get_bd_pins BLANKING_HEIGHT/gpio_io_o] [get_bd_pins address_gen_param_0/BLANKING_HEIGHT]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins BLANKING_HEIGHT/s_axi_aclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/M01_ACLK] [get_bd_pins axi_mem_intercon/M02_ACLK] [get_bd_pins axi_mem_intercon/M03_ACLK] [get_bd_pins axi_mem_intercon/M04_ACLK] [get_bd_pins axi_mem_intercon/M05_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins BLANKING_HEIGHT/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/M01_ARESETN] [get_bd_pins axi_mem_intercon/M02_ARESETN] [get_bd_pins axi_mem_intercon/M03_ARESETN] [get_bd_pins axi_mem_intercon/M04_ARESETN] [get_bd_pins axi_mem_intercon/M05_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x41230000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs BLANKING_HEIGHT/S_AXI/Reg] SEG_BLANKING_HEIGHT_Reg
